...
# python gdl_apps/EMOCA/demos/test_emoca_on_images.py --input_folder /search/odin/bxh/BXH_EMOCA/gdl_apps/EMOCA/test_Img/000002.jpg --output_folder ./1.png --model_name EMOCA 
import sys
sys.path.append('/search/odin/bxh/BXH_EMOCA')
